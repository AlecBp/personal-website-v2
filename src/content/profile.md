...
I'm a Staff Software Engineer at ServiceTitan, where I lead one of the teams behind Contact Center Pro, the company's cloud contact-center product. Most of what I build is backend: shared libraries, caching and billing pieces that other teams rely on, and the plumbing that keeps things running when something upstream breaks. I've been doing this for more than five years, across Schedule Engine, Scheduling Pro and Contact Center Pro.
